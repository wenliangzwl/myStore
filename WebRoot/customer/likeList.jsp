			 ...
			 <c:if test="${optt==null&&opttt==null}"><a href="<%=basePath %>customer/login.jsp">请登陆</a>
              ...
              <div class="header_1_r">
                   <ul>
						...
						<li><a href="<%=basePath %>customer/buy.jsp">购物车<span class="red">${size}</span>件						</a></li>
...
<div class="container">
    ...
    <div class="clearfloat"></div>
     ...
     <div class="today">
         ...
         <ul>
              <c:forEach var ="bookinfo"  items="${bookinfos}">
              	<li>
                        <a href="">
                             <div class="pics"><img src="${bookinfo.bookimg}" width="178" height="168" alt="" title=""/></div>
                             <div class="tt">${bookinfo.bookname}</div>
                             <div class="no_price"><span class="dj">定价：<del>￥${bookinfo.bookprice}</del></span><span class="yhj">优惠价<b>￥${bookinfo.discountprice}</b></span></div>
                        </a>
                   </li>      
              </c:forEach>
              </ul>
     ...
     <div class="pages"> 
        <span class="disabled">&lt;&lt;<a href="queryListServlet?page=${page-1 }&grade=${grade}">上一页 &gt;&gt; </a></span>
<!--         <span class="current">1</span> -->
        <a href="queryListServlet?page=2&grade=${grade}">2</a>
        <a href="queryListServlet?page=3&grade=${grade}">3</a>
        <a href="queryListServlet?page=4&grade=${grade}">4</a>
        <a href="queryListServlet?page=5&grade=${grade}">5</a>
        <a href="queryListServlet?page=6&grade=${grade}">6</a>
        <a href="queryListServlet?page=${page+1 }&grade=${grade}">下一页 &gt;&gt; </a>
