...
$(function(){
	...
	function OK(){
	window.location="<%=basePath %>User_AddcommentServlet?bookid="+document.getElementById("a").innerText+"&contents="+contents.value+"";
	}
</script>
<style type="text/css">
...
<div class="header">
	...
	<div id="center" Style="background-color:pink;width:400px;height:600px ;margin-left:200px;margin-top:50px">
	<table  align="center"  >
	<tr><td>书籍ID:</td><td  id="a">${bookinfo.bookid }</td></tr>
	<tr><td>我的评论</td><td><textarea id="contents" rows="10" cols="30"></textarea><td></tr>
	<tr><td colspan="2"><input type="button" value="提交" onclick="OK()"/></td></tr>
	</table>
	</div>
	<div class="footer">
     <div class="footer_t">
