...
<body>
    ...
    <div class="user_cont">
         ...
         <div class="user_cont_left">
                   ...
                   <dd class="active"><a href="<%=basePath %>">我的账单</a></dd>
                 ...
                 <table width="713" border="0" cellspacing="0" cellpadding="0"  class="my_dd">
                       <tr>
                        ...
                        <tr>
                            ...
                            <td width="163">
                                 <div class="dd_img"><a href="" target="_blank"><img src="<%=basePath %>customer/images/user_img.jpg" width="132" height="121" /></a></div>
