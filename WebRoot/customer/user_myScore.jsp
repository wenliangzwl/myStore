...
<script type="text/javascript">
	...
	function number() {
		...
		for (var i = 0; i < ${totalpage}; i++) {
			res += "<a href='<%=basePath %>	User_myScoreServlet?pageIndex="	+ (i + 1) + "' class='active'>" + (i + 1) + " </a>";
		}
...
<body onload="number()">
    ...
    <div class="user_cont">
         ...
         <div class="user_cont_left">
               ...
               <dl>
                   <dt>我的账户</dt>
                   <dd class="active"><a href="<%=basePath %>User_myScoreServlet">我的积分</a></dd>
		...
		$(this).toggleClass("jia"); return false;
         ...
         <div class="user_cont_right">
           <div class="user_lmt">
                    ...
                    <div class="user_lmt2">
                        <div class="user_lmt21"><a href="<%=basePath %>User_scoreExchageRecord_QueryServlet?">兑换记录查询</a></div>
               ...
               <div class="user_coment">
                 <table width="713" border="0" cellspacing="0" cellpadding="0"  class="my_dd">
                       <tr>
                            <th height="48" colspan="4">可换购书籍信息</th>
                            <th height="48" colspan="3">换购所需积分</th>
                        </tr>
