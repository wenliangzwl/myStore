    ...
    <div class="user_cont">
         ...
         <div class="user_cont_left">
               ...
               <dl>
                   ...
                   <dd class="active"><a href="<%=basePath %>customer/user_myAdress.jsp">我的收获地址</a></dd>
         ...
         <div class="user_cont_right">
           ...
           <div class="user_coment">
                     ...
                     <dl>
                          ...
                          <dd>
                               <div>
                                  ...
                                  <script class="resources library" src="<%=basePath %>customer/js/area.js" type="text/javascript"></script>
                ...
                <table width="713" border="0" cellspacing="0" cellpadding="0" class="address_list">
                    ...
                    <tr>
                      <td><div align="center">王亚军</div></td>
                      <td>湖北省武汉市洪山区卓刀泉街道</td>
                      <td>卓刀泉南路90号花香假日保利华都7栋1单元1401</td>
                      <td><div align="center">430070</div></td>
                      <td><div align="center">15878954855</div></td>
