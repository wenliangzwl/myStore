...
<!--									<input id="address" name="address" type="hidden" value="" />						-->
			...
			<tr>
				<td valign="top">
					...
					<table align="center" border="0" bordercolor="#666666" cellpadding="0" cellspacing="2" width="100%">
						...
						<td align="center" bgcolor="#E4E4E4"  >
								<a href="<%=basePath %>Admin_MemberInfo_ManageServlet?userid=${list.userinfo.userid }"> 删除 </a>
							</td>
						</tr>
						</c:forEach>
				...
				<c:if test="${page>1 }">
				<a href="<%=basePath %>Admin_MemberInfoServlet?page=${page-1 }">上一页</a>	
				</c:if>
				<c:if test="${page<=1 }">
				上一页
				</c:if>
				<c:if test="${page<pages }">
				<a href="<%=basePath %>Admin_MemberInfoServlet?page=${page+1}">
				下一页</a>	  
				</c:if>
				<c:if test="${page>=pages }">
						下一页			
