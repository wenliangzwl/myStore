...
@WebServlet("/Admin_productCommentInfo_ManageServlet")
public class Admin_productCommentInfo_ManageServlet extends HttpServlet {
	public Admin_productCommentInfo_ManageServlet() {
		super();
	}
